...
ActiveRecord::Schema[8.0].define(version: 2026_02_27_103000) do
  ...
  create_table "job_requests", force: :cascade do |t|
    ...
    t.index ["service_id"], name: "index_job_requests_on_service_id"
    t.index ["status"], name: "index_job_requests_on_status"
    t.index ["worker_id"], name: "index_job_requests_on_worker_id"
  end
  ...
  create_table "worker_profiles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["availability"], name: "index_worker_profiles_on_availability"
    t.index ["city_id"], name: "index_worker_profiles_on_city_id"
  ...
  add_foreign_key "job_requests", "services"
  add_foreign_key "job_requests", "users", column: "customer_id"
  add_foreign_key "job_requests", "users", column: "worker_id"
  add_foreign_key "notifications", "users"
  add_foreign_key "services", "categories"
  add_foreign_key "worker_profiles", "cities"
